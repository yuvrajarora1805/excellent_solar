...
CREATE TABLE IF NOT EXISTS service_tickets (
  ...
  service_type ENUM('WARRANTY', 'FREE', 'PAID') DEFAULT 'FREE',
  payment_status ENUM('PENDING', 'PAID', 'NOT_APPLICABLE') DEFAULT 'NOT_APPLICABLE',
  resolved_at TIMESTAMP NULL,
  resolution TEXT,
  resolution_photo_path VARCHAR(500) DEFAULT NULL,
  resolution_latitude DECIMAL(10,8) DEFAULT NULL,
  resolution_longitude DECIMAL(11,8) DEFAULT NULL,
  customer_rating INT,
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  status ENUM('DRAFT', 'SENT_TO_OFFICE', 'ACCEPTED_BY_OFFICE', 'PENDING_DISPATCH', 'READY_FOR_DISPATCH', 'DISPATCHED', 'DELIVERED', 'CANCELLED') DEFAULT 'DRAFT',
  created_by INT,
